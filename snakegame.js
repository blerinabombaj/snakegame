...
<body>
    ...
    <script>
        ...
        px=py=10; gs=tc=20; ax=ay=15; xv=yv=0; trail=[]; tail=5;
        function game() {
            px+=xv; py+=yv;
...
server.listen(81, () => console.log('Game is running on Port 81!'));
